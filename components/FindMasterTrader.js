          ...
          <Col sm={6} className="d-flex">
            <div className="w-full">
               <div className="w-full wow fadeInUp">
                <img className="my-4 mx-auto lg:w-96 md:w-80 sm:w-full w-full" src="/assets/images/promotion/trader_1.png" alt="Awesome Image" />
              </div>
            </div>
          </Col>
          <Col sm={6} className="d-flex">
            <div className="w-full">
               <div className="w-full wow fadeInDown">
                <img className="my-4 mx-auto lg:w-96 md:w-80 sm:w-full w-full" src="/assets/images/promotion/trader_2.png" alt="Awesome Image" />
              </div>
            </div>
          </Col>
        </Row>
