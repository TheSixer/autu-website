        ...
        <Row className="justify-content-md-center">
          <Col sm="9">
            ...
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
              Protecting your privacy and personal and financial data is one of our top priorities at Autu Securities. This Agreement contains the rules and purposes for processing Autu clients' personal data as well as the measures we employ to protect this data from unauthorized access by third parties.
            </Typography>
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
            ...
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
              1.1 By registering a Personal Area, you agree to have your personal data processed and specifically consent to the collection, systemization, aggregation, storage, revision (updating, changing), usage, anonymization, blocking, deletion, and distribution (transfer) of said personal data to third parties in accordance with the conditions set forth in this Privacy Agreement and the Firm's Privacy Policy, which is available upon request.
            </Typography>
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
              1.2 We ask you for the data necessary for registering a Personal Area, providing functional service, and using this data if a dispute arises between you and Autu. Providing this data is required for client identification and thus allows you to perform various operations in your Personal Area and trading accounts.
            </Typography>
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
            ...
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
              2.3 In accordance with these Terms and the Firm's Privacy Policy, the Firm (and its Associated Firms where required) will process the Client's personal data. The Firm will treat all information it holds about the Client as private and confidential, even when the Client is no longer a customer. The Client agrees, however, that the Firm and any of its Associated Firms may use the Client's information for various purposes, such as determining the Client's identity and background for money laundering and regulatory purposes, administering and operating the Client's Account, monitoring and analyzing its conduct, providing Services to the Client, improving any of the Firm's operations, procedures, products, and/or Services, assessing any credit limit or other credit decision, enabling the Firm to carry out statistical and other analysis, and complying and cooperating with regulators and the courts and to comply with its legal obligations.
            </Typography>
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
              Providing personal data to third parties
            </Typography>
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
              3.1 We do not provide your personal data to third parties except in the cases set forth by this Privacy Agreement and the Firm's Privacy Policy.
            </Typography>
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
            ...
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
              Commencement and amendment of the Privacy Agreement
            </Typography>
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
              6.1 By registering a Personal Area, you agree to and accept all of the provisions set forth in the Privacy Agreement. Communication between you and Autu begins as soon as we send you an email confirming your registration on our website. We may also send you information about changes and new services via email or receive emails with your questions and suggestions. This information is not confidential.
            </Typography>
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
            ...
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
              6.5 Occasionally, we may update the Privacy Agreement and immediately post the new version to our website. We recommend that you periodically read this Agreement in order to always have the latest information concerning how your personal data is processed.
            </Typography>
            <Typography variant="subtitle1" color="textPrimary" gutterBottom>
            ...
            <Typography variant="button" display="block" align="right" color="textPrimary" gutterBottom>
              <b>Autu Securities International Inc.</b>
            </Typography>
          </Col>
        </Row>
      </Container>
